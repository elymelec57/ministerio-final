...
<div class="row mt-3">
              <!--  <form class="row mt-3">-->
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Titulo del evento</p>
                  <input type="text" wire:model="nombre" class="<?php echo e($errors->has('nombre') ? 'is-invalid' : ''); ?> form-control">
...
<?php endif; ?>
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Dirección del evento</p>
                  <input type="text" wire:model="direccion" class="<?php echo e($errors->has('direccion') ? 'is-invalid' : ''); ?> form-control">
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Fecha de apertura</p>
                  <input type="date" wire:model="apertura" class="<?php echo e($errors->has('apertura') ? 'is-invalid' : ''); ?> form-control">
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Fecha de culminación</p>
                  <input type="date" wire:model="clausura" class="<?php echo e($errors->has('clausura') ? 'is-invalid' : ''); ?> form-control">
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Hora del evento</p>
                  <input type="time" wire:model="hora" class="<?php echo e($errors->has('hora') ? 'is-invalid' : ''); ?> form-control" >
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Imagen para el evento</p>
                  <input type="file"  wire:model="file" class="<?php echo e($errors->has('file') ? 'is-invalid' : ''); ?> form-control">
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                ...
                <label class="col-lg-12 text-center"><p class="btn-success text-white pt-1 mt-2">Información extra del evento</p>
                  <textarea type="text"  wire:model="informacion" class="<?php echo e($errors->has('informacion') ? 'is-invalid' : ''); ?> form-control"></textarea>
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
</div><?php /**PATH /var/www/html/ministerio/resources/views/livewire/form.blade.php ENDPATH**/ ?>