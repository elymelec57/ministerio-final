...
<div class="row mt-3">
              <!--  <form class="row mt-3">-->
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Nombre</p>
                  <input type="text" wire:model.defer="name"  class="{{ $errors->has('name') ? 'is-invalid' : '' }} form-control">
                  <x-jet-input-error for="name"></x-jet-input-error>
                </label> 
               
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Email</p>
                  <input type="text" wire:model.defer="email" class="{{ $errors->has('email') ? 'is-invalid' : '' }} form-control">
                  <x-jet-input-error for="email"></x-jet-input-error>
                </label> 
               
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Contraseña</p>
                  <input type="password" wire:model.defer="password" name="password" class="{{ $errors->has('password') ? 'is-invalid' : '' }} form-control">
