...
<div class="row mt-3">
              <!--  <form class="row mt-3">-->
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Titulo del evento</p>
                  <input type="text" wire:model.defer="nombre" name="nombre" id="nombre" class="{{ $errors->has('nombre') ? 'is-invalid' : '' }} form-control" value="{{old('nombre')}}">
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Dirección del evento</p>
                  <input type="text" wire:model.defer="direccion" class="{{ $errors->has('direccion') ? 'is-invalid' : '' }} form-control" value="{{old('direccion')}}">
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Fecha de apertura</p>
                  <input type="date" wire:model.defer="apertura"  class="{{ $errors->has('apertura') ? 'is-invalid' : '' }} form-control" value="{{old('apertura')}}">
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Fecha de culminación</p>
                  <input type="date" wire:model.defer="clausura" class="{{ $errors->has('clausura') ? 'is-invalid' : '' }} form-control" value="{{old('clausura')}}">
                ...
                <label class="col-lg-6 text-center"><p class="btn-success text-white pt-1 mt-2">Hora del evento</p>
                  <input type="time" wire:model.defer="hora" class="{{ $errors->has('hora') ? 'is-invalid' : '' }} form-control" value="{{old('hora')}}">
                ...
                <label class="col-lg-12 text-center"><p class="btn-success text-white pt-1 mt-2">Información extra del evento</p>
                  <textarea type="text" wire:model.defer="informacion" class="{{ $errors->has('informacion') ? 'is-invalid' : '' }} form-control" value="{{old('informacion')}}"></textarea>
